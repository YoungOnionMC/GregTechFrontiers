...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.mixer('gtceu:mixer/raw_mana_crystal_slurry')
        ...
        .duration(120)
        .EUt(GTValues.VA[GTValues.MV]);
    event.recipes.gtceu.chemical_dehydrator('gtceu:mixer/prepared_terrasteel')
        .itemInputs('botania:mana_pearl')
        .inputFluids('gtceu:raw_mana_crystal_slurry 1000')
        .inputFluids('gtceu:hydrochloric_acid 1000')
        .outputFluids('gtceu:prepared_terrasteel 1000')
    ...
    event.recipes.gtceu.chemical_reactor('gtceu:chemical_reactor/unstable_terrasteel')
        .inputFluids(['gtceu:prepared_terrasteel 1000', 'gtceu:potent_mana 1000'])
