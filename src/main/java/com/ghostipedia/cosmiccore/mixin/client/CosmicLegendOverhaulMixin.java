...
public abstract class CosmicLegendOverhaulMixin{
    /**
     * @author God
     * @reason FUK
     * don't ask why HEALTH_GUI marks itself as red, i can't get it to import but it works on the overwrite so SHRUG
     */
//    @Overwrite
//    @SubscribeEvent
